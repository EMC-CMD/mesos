...
inline const ::mesos::InverseOffer& Event_Offers::inverse_offers(int index) const {
  return inverse_offers_.Get(index);
}
inline ::mesos::InverseOffer* Event_Offers::mutable_inverse_offers(int index) {
  return inverse_offers_.Mutable(index);
}
inline ::mesos::InverseOffer* Event_Offers::add_inverse_offers() {
