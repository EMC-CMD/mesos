...
// optional .mesos.TaskState state = 4;
inline bool Termination::has_state() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Termination::set_has_state() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Termination::clear_has_state() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Termination::clear_state() {
  state_ = 6;
  clear_has_state();
}
inline ::mesos::TaskState Termination::state() const {
  return static_cast< ::mesos::TaskState >(state_);
}
inline void Termination::set_state(::mesos::TaskState value) {
...
// repeated .mesos.TaskStatus.Reason reasons = 5;
inline int Termination::reasons_size() const {
  return reasons_.size();
}
inline void Termination::clear_reasons() {
  reasons_.Clear();
}
inline ::mesos::TaskStatus_Reason Termination::reasons(int index) const {
  return static_cast< ::mesos::TaskStatus_Reason >(reasons_.Get(index));
}
inline void Termination::set_reasons(int index, ::mesos::TaskStatus_Reason value) {
  assert(::mesos::TaskStatus_Reason_IsValid(value));
  reasons_.Set(index, value);
}
inline void Termination::add_reasons(::mesos::TaskStatus_Reason value) {
  assert(::mesos::TaskStatus_Reason_IsValid(value));
  reasons_.Add(value);
}
inline const ::google::protobuf::RepeatedField<int>&
Termination::reasons() const {
  return reasons_;
}
inline ::google::protobuf::RepeatedField<int>*
Termination::mutable_reasons() {
  return &reasons_;
}
