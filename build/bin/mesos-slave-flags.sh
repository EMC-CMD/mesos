...
export MESOS_LAUNCHER_DIR=/home/vagrant/mesos/build/src
...
if test $(uname) = 'Darwin'; then
  MESOS_NATIVE_JAVA_LIBRARY=/home/vagrant/mesos/build/src/.libs/libmesos-0.26.0.dylib
  MESOS_NATIVE_LIBRARY=/home/vagrant/mesos/build/src/.libs/libmesos-0.26.0.dylib
else
  MESOS_NATIVE_JAVA_LIBRARY=/home/vagrant/mesos/build/src/.libs/libmesos-0.26.0.so
  MESOS_NATIVE_LIBRARY=/home/vagrant/mesos/build/src/.libs/libmesos-0.26.0.so
fi
