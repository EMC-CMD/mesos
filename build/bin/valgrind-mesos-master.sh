...
. /home/vagrant/mesos/build/../support/colors.sh
...
LIBTOOL=/home/vagrant/mesos/build/libtool
...
. /home/vagrant/mesos/build/bin/mesos-master-flags.sh

exec ${LIBTOOL} --mode=execute valgrind --tool=${VALGRINDTOOL} \
  /home/vagrant/mesos/build/src/mesos-master "${@}"
