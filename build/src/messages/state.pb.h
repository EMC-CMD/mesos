...
const Operation_Type Operation_Type_Type_MAX = Operation_Type_DIFF;
...
class Operation_Diff : public ::google::protobuf::Message {
 public:
  Operation_Diff();
  virtual ~Operation_Diff();

  Operation_Diff(const Operation_Diff& from);

  inline Operation_Diff& operator=(const Operation_Diff& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const Operation_Diff& default_instance();

  void Swap(Operation_Diff* other);

  // implements Message ----------------------------------------------

  Operation_Diff* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const Operation_Diff& from);
  void MergeFrom(const Operation_Diff& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static Operation_Diff* default_instance_;
};
// -------------------------------------------------------------------
...
class Operation : public ::google::protobuf::Message {
 public:
  ...
  inline const ::mesos::internal::state::Operation_Diff& diff() const;
  inline ::mesos::internal::state::Operation_Diff* mutable_diff();
  inline ::mesos::internal::state::Operation_Diff* release_diff();
  inline void set_allocated_diff(::mesos::internal::state::Operation_Diff* diff);
 ...
 private:
  ...
  ::mesos::internal::state::Operation_Diff* diff_;
...
// required .mesos.internal.state.Entry entry = 1;
inline bool Operation_Diff::has_entry() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Operation_Diff::set_has_entry() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Operation_Diff::clear_has_entry() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Operation_Diff::clear_entry() {
  if (entry_ != NULL) entry_->::mesos::internal::state::Entry::Clear();
  clear_has_entry();
}
inline const ::mesos::internal::state::Entry& Operation_Diff::entry() const {
  return entry_ != NULL ? *entry_ : *default_instance_->entry_;
}
inline ::mesos::internal::state::Entry* Operation_Diff::mutable_entry() {
  set_has_entry();
  if (entry_ == NULL) entry_ = new ::mesos::internal::state::Entry;
  return entry_;
}
inline ::mesos::internal::state::Entry* Operation_Diff::release_entry() {
  clear_has_entry();
  ::mesos::internal::state::Entry* temp = entry_;
  entry_ = NULL;
  return temp;
}
inline void Operation_Diff::set_allocated_entry(::mesos::internal::state::Entry* entry) {
  delete entry_;
  entry_ = entry;
  if (entry) {
    set_has_entry();
...
// optional .mesos.internal.state.Operation.Diff diff = 4;
inline bool Operation::has_diff() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Operation::set_has_diff() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Operation::clear_has_diff() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Operation::clear_diff() {
  if (diff_ != NULL) diff_->::mesos::internal::state::Operation_Diff::Clear();
  clear_has_diff();
}
inline const ::mesos::internal::state::Operation_Diff& Operation::diff() const {
  return diff_ != NULL ? *diff_ : *default_instance_->diff_;
}
inline ::mesos::internal::state::Operation_Diff* Operation::mutable_diff() {
  set_has_diff();
  if (diff_ == NULL) diff_ = new ::mesos::internal::state::Operation_Diff;
  return diff_;
}
inline ::mesos::internal::state::Operation_Diff* Operation::release_diff() {
  clear_has_diff();
  ::mesos::internal::state::Operation_Diff* temp = diff_;
  diff_ = NULL;
  return temp;
}
inline void Operation::set_allocated_diff(::mesos::internal::state::Operation_Diff* diff) {
  delete diff_;
  diff_ = diff;
  if (diff) {
    set_has_diff();
