...
const ::google::protobuf::Descriptor* Operation_Diff_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  Operation_Diff_reflection_ = NULL;
...
void protobuf_AssignDesc_messages_2fstate_2eproto() {
  ...
  static const int Operation_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Operation, diff_),
  ...
  Operation_Diff_descriptor_ = Operation_descriptor_->nested_type(1);
  static const int Operation_Diff_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Operation_Diff, entry_),
  };
  Operation_Diff_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Operation_Diff_descriptor_,
      Operation_Diff::default_instance_,
      Operation_Diff_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Operation_Diff, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Operation_Diff, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(Operation_Diff));
  Operation_Expunge_descriptor_ = Operation_descriptor_->nested_type(2);
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    Operation_Diff_descriptor_, &Operation_Diff::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_messages_2fstate_2eproto() {
  ...
  delete Operation_Diff::default_instance_;
  delete Operation_Diff_reflection_;
...
void protobuf_AddDesc_messages_2fstate_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\014\022\r\n\005value\030\003 \002(\014\"\233\003\n\tOperation\0222\n\004type\030\001"
    " \002(\0162$.mesos.internal.state.Operation.Ty"
    "pe\022:\n\010snapshot\030\002 \001(\0132(.mesos.internal.st"
    "ate.Operation.Snapshot\0222\n\004diff\030\004 \001(\0132$.m"
    "esos.internal.state.Operation.Diff\0228\n\007ex"
    "punge\030\003 \001(\0132\'.mesos.internal.state.Opera"
    "tion.Expunge\0326\n\010Snapshot\022*\n\005entry\030\001 \002(\0132"
    "\033.mesos.internal.state.Entry\0322\n\004Diff\022*\n\005"
    "entry\030\001 \002(\0132\033.mesos.internal.state.Entry"
    "\032\027\n\007Expunge\022\014\n\004name\030\001 \002(\t\"+\n\004Type\022\014\n\010SNA"
    "PSHOT\020\001\022\010\n\004DIFF\020\003\022\013\n\007EXPUNGE\020\002", 510);
  ...
  Operation_Diff::default_instance_ = new Operation_Diff();
  ...
  Operation_Diff::default_instance_->InitAsDefaultInstance();
...
const Operation_Type Operation::DIFF;
...
#ifndef _MSC_VER
const int Operation_Diff::kEntryFieldNumber;
#endif  // !_MSC_VER
...
void Operation_Diff::InitAsDefaultInstance() {
  entry_ = const_cast< ::mesos::internal::state::Entry*>(&::mesos::internal::state::Entry::default_instance());
}

Operation_Diff::Operation_Diff(const Operation_Diff& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void Operation_Diff::SharedCtor() {
  _cached_size_ = 0;
  entry_ = NULL;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void Operation_Diff::SharedDtor() {
  if (this != default_instance_) {
    delete entry_;
  }
}

void Operation_Diff::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* Operation_Diff::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return Operation_Diff_descriptor_;
}

const Operation_Diff& Operation_Diff::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_messages_2fstate_2eproto();
  return *default_instance_;
}

Operation_Diff* Operation_Diff::default_instance_ = NULL;

Operation_Diff* Operation_Diff::New() const {
  return new Operation_Diff;
}

void Operation_Diff::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (has_entry()) {
      if (entry_ != NULL) entry_->::mesos::internal::state::Entry::Clear();
    }
...
bool Operation_Diff::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void Operation_Diff::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required .mesos.internal.state.Entry entry = 1;
  if (has_entry()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
...
::google::protobuf::uint8* Operation_Diff::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // required .mesos.internal.state.Entry entry = 1;
  if (has_entry()) {
    target = ::google::protobuf::internal::WireFormatLite::
...
int Operation_Diff::ByteSize() const {
  int total_size = 0;
...
void Operation_Diff::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const Operation_Diff* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const Operation_Diff*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void Operation_Diff::MergeFrom(const Operation_Diff& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_entry()) {
      mutable_entry()->::mesos::internal::state::Entry::MergeFrom(from.entry());
...
void Operation_Diff::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Operation_Diff::CopyFrom(const Operation_Diff& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Operation_Diff::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;
...
void Operation_Diff::Swap(Operation_Diff* other) {
  if (other != this) {
    std::swap(entry_, other->entry_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
...
::google::protobuf::Metadata Operation_Diff::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = Operation_Diff_descriptor_;
  metadata.reflection = Operation_Diff_reflection_;
  return metadata;
}
...
const int Operation::kDiffFieldNumber;
...
void Operation::InitAsDefaultInstance() {
  ...
  diff_ = const_cast< ::mesos::internal::state::Operation_Diff*>(&::mesos::internal::state::Operation_Diff::default_instance());
...
void Operation::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (has_diff()) {
      if (diff_ != NULL) diff_->::mesos::internal::state::Operation_Diff::Clear();
    }
    if (has_expunge()) {
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_diff;
        break;
      }
...
void Operation::MergeFrom(const Operation& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_diff()) {
      mutable_diff()->::mesos::internal::state::Operation_Diff::MergeFrom(from.diff());
    }
    if (from.has_expunge()) {
